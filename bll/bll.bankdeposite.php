<?php
include($_SERVER['DOCUMENT_ROOT'].'/dal/dal.bankdeposite.php');
...
class BLLBankDeposite
{
	...
	function __construct()
	{
		...
		if(isset($_POST['insert_bankdeposite']))
		{
			...
			$result = $dalBankDeposite->insertBankDeposite($tokenNo,$bankName,$netAmount,$date);
			if($result)
			{
		...
		if(isset($_POST['update_bankdeposite']))
		{
			...
			$result = $dalBankDeposite->updateBankDeposite($id,$tokenNo,$bankName,$netAmount,$date);
